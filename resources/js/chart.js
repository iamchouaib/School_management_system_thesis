...
(function () {
    ...
    if ($("#report-students").length) {
        let ctx = $("#report-students")[0].getContext("2d");
        axios.get(`http://127.0.0.1:8000/api/chart/line`, {}).then(res => {

        const userDataSet =  {
                data: res.data.userData,
                label: res.data.userLabel,
                borderWidth: 2,
                borderColor: colors.primary(0.8),
                backgroundColor: "transparent",
                pointBorderColor: "transparent",
            ...
            console.log({studentDataSet , userDataSet});
            let myChart = new Chart(ctx, {
                type: "line",
                data: {
                    labels: [
    ...
    if ($("#report-pie-chart").length) {
        ...
        let students = $('#students_count').val();
        let parents = $('#parents_count').val() ;
        let users = $('#users_count').val() ;
