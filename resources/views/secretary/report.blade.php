...
@section('subcontent')
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        ...
        @foreach($grades as $grade)
            <a id="g-{{$grade->id}}"
               onclick="show_section('{{$grade->id}}')"
               class="grade intro-y col-span-12 lg:col-span-4 box py-10 border-2">
                <i data-lucide="{{$grade->logo}}"
                   class="block w-12 h-12 text-primary mx-auto"></i>
                <div
                    class="font-medium text-center text-base mt-3 cursor-pointer">{{$grade->name}}</div>
                <div
                    class="text-slate-500 mt-2 w-3/4 text-center mx-auto"> {{substr($grade->description , 0 , 50 )}}
                    ...
                </div>
            </a>
    @endforeach
    ...
    <!-- END: FAQ Menu -->
        ...
        <div id="show-sections"
             class="hidden intro-y col-span-12 lg:col-span-12">
            <div class="box">
                <div
                    ...
                    <div class="accordion-item">
                        ...
                        <div
                            ...
                            <div
                                ...
                                <div
                                    id="sections_aria"
                                    class="grid grid-cols-12 gap-5 mt-5">
    ...
    {{--                                    class="text-danger font-bold">{{$grade->name}}</span> Grade ? <br>--}}
...
@section('script')
    ...
    <script>
        ...
        function show_section(id) {
            ...
            $('#show-sections').removeClass('hidden')
 ...
 <div class="tb intro-y overflow-auto lg:overflow-visible bg-primary p-4 text-white">
        ...
        function show_groupes(id) {
            ...
            $('#show-groups').removeClass('hidden')
            ...
            axios.get(`http://127.0.0.1:8000/api/groupesBySection/${id}`, {})
                .then(res => {
                    ...
                    res.data.forEach((groupe) => {
                        ...
                        tableRow.classList.add('intro-x', 'py-2',)
                        ...
                        actionLink.classList.add('btn', 'btn-primary', 'font-bold', 'mr-2');
                        actionLink.setAttribute('onclick', 'show_students(5)')
                        actionLink.append('Students')
        ...
        function show_students(id) {
            ...
            $('#show-students').removeClass('hidden')
            ...
            axios.get(`http://127.0.0.1:8000/api/studentsByGroupe/${id}`, {})
                .then(res => {


                    res.data.forEach((student) => {
                        $('#students').append(`<div id="s-${student.id}" class="-intro-y rm section border border-slate-300 col-span-12 sm:col-span-4 2xl:col-span-3 box p-5 cursor-pointer  mb-2 ">
                            <a href="report-cards/${student.id}/show">
                                <div class="font-medium text-base">
                                    <span class="font-bold cursor-pointer"> ${student.name}</span>
                                    <span class="text-primary font-bold"> <span class="text-pending">(</span> ${student.guardian.name} </span>  <span class="text-pending">)</span> </div>
                                <div class="text-slate-500 mt-2 ">${student.groupe_id} groupes </div>
                            </a>
