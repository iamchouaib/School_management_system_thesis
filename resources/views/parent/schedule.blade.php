...
@section('subcontent')
    ...
    <div class="grid grid-cols-12 gap-5 mt-5">
            ...
            <div class="box p-5 intro-y">
                ...
                <div class="border-t border-b border-slate-200/60 dark:border-darkmode-400 mt-6 mb-5 py-3"
                    ...
                    <div class="relative mb-4">
                        <label for="choose_groupe" class="form-label">Student</label>
                        <select data-placeholder="Select your child" class="tom-select" name="choose-student"
                                id="choose-student">
        ...
        <div class="col-span-12 xl:col-span-8 2xl:col-span-9">
            <div class="box p-5">
                <div class="full-calendar" id="calendar-parent"></div>
            </div>
        </div>
